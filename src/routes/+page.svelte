<script>
	...
	const features = [
		...
		},
		{
			...
			description: 'Sellers can split their profits among contributors.'
		},
		{
			title: 'Low Distributed Transaction Fee',
			description: 'You keep 92%. We keep 5%. We donate 3% to open source game engines.'
		}
	];
